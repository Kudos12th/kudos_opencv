...
def bev(image):
    ...
    source = np.float32([[240, 100], [190, 480], [400, 100], [450, 480]])
...
def main():
    ...
    while not rospy.is_shutdown():
        if cv_image is not None:
            ...
            # line_contours, line_hier = cv2.findContours(line_img, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
            ...
            if line_contours:
                ...
                cv2.circle(bev_frame, line_largest_contour[0][0], 3, (0, 255, 0), -1)
